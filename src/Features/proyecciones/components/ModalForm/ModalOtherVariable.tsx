...
import { createOtherVariable } from "Features/proyecciones/servicios/otherVariable/create.servicio";

export default function ModalFormOtherVariable({ AllOtherVariable }: any ) {
  ...
  const onSubmit: SubmitHandler<Ivariable> = (data) => {
    createOtherVariable("proyeccion/otherVariable", data)
